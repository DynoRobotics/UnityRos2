...
def generate_launch_description():
    ...
    declare_map_yaml_cmd = launch.actions.DeclareLaunchArgument(
        'map',
        default_value=os.path.join(launch_dir, 'empty_map.yaml'),
    ...
    urdf_filename = os.path.join(
        get_package_share_directory('dredging_robot_description'),
        'urdf/dredging_robot_simple.urdf')
