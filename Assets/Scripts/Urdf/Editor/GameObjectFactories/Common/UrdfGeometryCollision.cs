...
namespace RosSharp.Urdf.Editor
{
    public class UrdfGeometryCollision : UrdfGeometry
    {
        ...
        private static GameObject CreateMeshCollider(UrdfLink.Geometry.Mesh mesh)
        {
        ...
        private static GameObject CreateCylinderCollider()
        {
            ...
            UrdfLink.Geometry.Cylinder cylinder = new UrdfLink.Geometry.Cylinder(0.5, 2); //Default unity cylinder sizes
