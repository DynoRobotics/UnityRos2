...
namespace RosSharp.Urdf.Editor
{
    public class UrdfGeometryFactory
    {
        ...
        public static UrdfLink.Geometry ExportGeometryData(GeometryTypes geometryType, Transform transform, bool isCollisionGeometry = false)
        {
            UrdfLink.Geometry geometry = null;
            switch (geometryType)
            {
                case GeometryTypes.Box:
                    geometry = new UrdfLink.Geometry(new UrdfLink.Geometry.Box(ExportUrdfSize(transform)));
                    break;
                case GeometryTypes.Cylinder:
                    geometry = new UrdfLink.Geometry(
                        null,
                        new UrdfLink.Geometry.Cylinder(ExportUrdfRadius(transform), ExportCylinderHeight(transform)));
                    break;
                case GeometryTypes.Sphere:
                    geometry = new UrdfLink.Geometry(null, null, new UrdfLink.Geometry.Sphere(ExportUrdfRadius(transform)));
                    break;
        ...
        public static GeometryTypes GetGeometryType(UrdfLink.Geometry geometry)
        {
        ...
        public static void SetScale(Transform transform, UrdfLink.Geometry geometry, GeometryTypes geometryType)
        {
            switch (geometryType)
            {
                case GeometryTypes.Box:
        ...
        public static Mesh CreateCylinderMesh(UrdfLink.Geometry.Cylinder cylinder)
        {
        ...
        private static UrdfLink.Geometry ExportGeometryMeshData(GameObject geometryObject, double[] urdfSize, bool isCollisionGeometry)
        {
            ...
            return new UrdfLink.Geometry(null, null, null, new UrdfLink.Geometry.Mesh(packagePath, urdfSize));
        }
