...
{
    public static class UrdfVisualsFactory
    {
        public static void Create(Transform parent, List<UrdfLink.Visual> visuals = null)
        {
            ...
            if (visuals != null)
            {
                foreach (UrdfLink.Visual visual in visuals)
                    UrdfVisualFactory.Create(urdfVisuals.transform, visual);
            }
        }

        public static List<UrdfLink.Visual> ExportVisualsData(this UrdfVisuals urdfVisuals)
        {
