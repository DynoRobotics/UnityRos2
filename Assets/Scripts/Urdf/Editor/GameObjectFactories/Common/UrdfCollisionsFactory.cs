...
{ 
    public static class UrdfCollisionsFactory
    {
        public static void Create(Transform parent, List<UrdfLink.Collision> collisions = null)
        {
            ...
            if (collisions != null)
            {
                foreach (UrdfLink.Collision collision in collisions)
                    UrdfCollisionFactory.Create(urdfCollisions.transform, collision);
            }
        }
        
        public static List<UrdfLink.Collision> ExportCollisionsData(this UrdfCollisions urdfCollisions)
        {
